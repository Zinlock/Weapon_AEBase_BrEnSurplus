datablock AudioProfile(BNE_TT33Fire1Sound)
{
   filename    = "./Sounds/Fire/TT33/TT33_FIRE_1.wav";
   description = LightClose3D;
   preload = true;
};

datablock AudioProfile(BNE_TT33Fire2Sound)
{
   filename    = "./Sounds/Fire/TT33/TT33_FIRE_2.wav";
   description = LightClose3D;
   preload = true;
};

datablock AudioProfile(BNE_TT33Fire3Sound)
{
   filename    = "./Sounds/Fire/TT33/TT33_FIRE_3.wav";
   description = LightClose3D;
   preload = true;
};

// TT33
datablock DebrisData(BNE_TT33MagDebris)
{
	shapeFile = "./TT33/TT33Mag.dts";
	lifetime = 2.0;
	minSpinSpeed = -200.0;
	maxSpinSpeed = -100.0;
	elasticity = 0.5;
...
// item //
//////////
datablock ItemData(BNE_TT33Item)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./TT33/TT33.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(BNE_TT33Image)
{
   // Basic Item properties
   shapeFile = "./TT33/TT33.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = BNE_TT33SafetyImage;
    scopingImage = BNE_TT33IronsightImage;
	doColorShift = true;
	colorShiftColor = BNE_TT33Item.colorShiftColor;//"0.400 0.196 0 1.000";
...
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, BNE_TT33Fire @ getRandom(1, 3) @ Sound);
...
function BNE_TT33Image::onDryFire(%this, %obj, %slot)
{
...
function BNE_TT33Image::onReloadEnd(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function BNE_TT33Image::onReload2End(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}
...
function BNE_TT33Image::onReady(%this,%obj,%slot)
{
...
function BNE_TT33Image::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function BNE_TT33Image::onUnMount(%this,%obj,%slot)
{
...
function BNE_TT33Image::onMagDrop(%this,%obj,%slot)
{
	%a = new Camera()
	{
		datablock = Observer;
	...
	%a.mountImage(BNE_TT33MagImage,0);
...
datablock ShapeBaseImageData(BNE_TT33MagImage)
{
...
function BNE_TT33MagImage::onDone(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(BNE_TT33SafetyImage)
{
   shapeFile = "./TT33/TT33.dts";
   emap = true;
   mountPoint = 0;
   ...
   hideHands = false;
   scopingImage = BNE_TT33IronsightImage;
   safetyImage = BNE_TT33Image;
   doColorShift = true;
   colorShiftColor = BNE_TT33Item.colorShiftColor;
...
function BNE_TT33SafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function BNE_TT33SafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
...
function BNE_TT33SafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
...
datablock ShapeBaseImageData(BNE_TT33IronsightImage : BNE_TT33Image)
{
	recoilHeight = 0.125;

	scopingImage = BNE_TT33Image;
	sourceImage = BNE_TT33Image;
	
   offset = "0 0 0.";
	eyeOffset = "0 1.25 -0.515";
...
function BNE_TT33IronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function BNE_TT33IronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function BNE_TT33IronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, BNE_TT33Fire @ getRandom(1, 3) @ Sound);
...
function BNE_TT33IronsightImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}
...
function BNE_TT33IronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function BNE_TT33IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
