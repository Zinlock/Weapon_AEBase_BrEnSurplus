datablock AudioProfile(BNE_M500TacFire1Sound)
{
   filename    = "./Sounds/Fire/M500/M500Tac_fire1.wav";
   description = LightClose3D;
   preload = true;
};

datablock AudioProfile(BNE_M500TacFire2Sound)
{
   filename    = "./Sounds/Fire/M500/M500Tac_fire2.wav";
   description = LightClose3D;
   preload = true;
};

datablock AudioProfile(BNE_M500TacFire3Sound)
{
   filename    = "./Sounds/Fire/M500/M500Tac_fire3.wav";
   description = LightClose3D;
   preload = true;
};
...
// item //
//////////
datablock ItemData(BNE_M500TacItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./M500/M500Tac.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "B&ES: Mossberg 500 Tac.";
	iconName = "./Icons/Icon_M500Tac";
	doColorShift = true;
	colorShiftColor = "0.6 0.6 0.6 1";

	 // Dynamic properties defined by the scripts
	image = BNE_M500TacImage;
	canDrop = true;
  ...
  Recoil = "Medium";
	uiColor = "1 1 1";
  description = "The Mossberg 500 is an accurate 12-gauge shotgun made for both civilian and military use. This variant is equiped with a silencer, and a red laser.";
...
//weapon image//
////////////////
datablock ShapeBaseImageData(BNE_M500TacImage)
{
   // Basic Item properties
   shapeFile = "./M500/M500Tac.dts";
   emap = true;
   ...
   armReady = true;
   safetyImage = BNE_M500TacSafetyImage;
   scopingImage = BNE_M500TacIronsightImage;
   doColorShift = true;
   colorShiftColor = BNE_M500TacItem.colorShiftColor;
...
function BNE_M500TacImage::AEOnFire(%this,%obj,%slot)
{
	...
	%obj.stopAudio(0); 
	%obj.playAudio(0, BNE_M500TacFire @ getRandom(1, 3) @ Sound);	

	Parent::AEOnFire(%this, %obj, %slot);
}

function BNE_M500TacImage::AEOnLowClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(3, jump);
   %obj.aeplayThread(0, plant);
}

function BNE_M500TacImage::AEOnMedClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(3, jump);
}

function BNE_M500TacImage::AEOnHighClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(3, jump);
   %obj.aeplayThread(0, jump);
}

function BNE_M500TacImage::onReloadStart(%this, %obj, %slot)
{
	%obj.aeplayThread(2, shiftleft); 
}

function BNE_M500TacImage::onReloadEnd(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function BNE_M500TacImage::onReload2End(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function BNE_M500TacImage::onReloadStart2(%this, %obj, %slot)
{
	%obj.aeplayThread(2, shiftright);
	serverPlay3D(BNE_M500PumpBackSound,%obj.getPosition());	
}

function BNE_M500TacImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}

function BNE_M500TacImage::onReady(%this,%obj,%slot)
{
...
function BNE_M500TacImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	parent::onMount(%this,%obj,%slot);
}

function BNE_M500TacImage::onUnMount(%this, %obj, %slot)
{	
...
function BNE_M500TacImage::LoadEffect(%this,%obj,%slot)
{
...
function BNE_M500TacImage::LoadEffectEmpty(%this,%obj,%slot)
{
...
function BNE_M500TacImage::AEShotgunLoadOneEffectless(%this,%obj,%slot)
{
	Parent::AEShotgunLoadOne(%this, %obj, %slot);
}

function BNE_M500TacImage::onPump(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant); 
	schedule(300, 0, serverPlay3D, AEShellShotgun @ getRandom(1,2) @ Sound, %obj.getPosition());
	serverPlay3D(BNE_M500TacPumpSound,%obj.getPosition());	
}
...
datablock ShapeBaseImageData(BNE_M500TacSafetyImage)
{
   shapeFile = "./M500/M500Tac.dts";
   emap = true;
   mountPoint = 0;
...
function BNE_M500TacSafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function BNE_M500TacSafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
...
function BNE_M500TacSafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
...
datablock ShapeBaseImageData(BNE_M500TacIronsightImage : BNE_M500TacImage)
{
	recoilHeight = 0.5;

	scopingImage = BNE_M500TacImage;
	sourceImage = BNE_M500TacImage;
...
function BNE_M500TacIronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function BNE_M500TacIronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function BNE_M500TacIronsightImage::AEOnFire(%this,%obj,%slot)
{
	%obj.blockImageDismount = true;
	%obj.schedule(500, unBlockImageDismount);
...
function BNE_M500TacIronsightImage::onPump(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant); 
...
function BNE_M500TacIronsightImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}
...
function BNE_M500TacIronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function BNE_M500TacIronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
