datablock AudioProfile(BNE_870XPFire1Sound)
{
   filename    = "./Sounds/Fire/870XP/870XP_fire1.wav";
   description = HeavyClose3D;
   preload = true;
};

datablock AudioProfile(BNE_870XPFire2Sound)
{
   filename    = "./Sounds/Fire/870XP/870XP_fire2.wav";
   description = HeavyClose3D;
   preload = true;
};

datablock AudioProfile(BNE_870XPFire3Sound)
{
   filename    = "./Sounds/Fire/870XP/870XP_fire3.wav";
   description = HeavyClose3D;
   preload = true;
};
...
// item //
//////////
datablock ItemData(BNE_870XPItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./870XP/870XP.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "B&ES: 870 Express";
	iconName = "./Icons/Icon_870";
	doColorShift = true;
	colorShiftColor = "0.6 0.6 0.6 1";

	 // Dynamic properties defined by the scripts
	image = BNE_870XPImage;
	canDrop = true;
  ...
  Recoil = "Medium";
	uiColor = "1 1 1";
  description = "The Remington Model 870 is a pump action shotgun chambered in 12 gauge buckshot.";
...
//weapon image//
////////////////
datablock ShapeBaseImageData(BNE_870XPImage)
{
   // Basic Item properties
   shapeFile = "./870XP/870XP.dts";
   emap = true;
   ...
   armReady = true;
   safetyImage = BNE_870XPSafetyImage;
   scopingImage = BNE_870XPIronsightImage;
   doColorShift = true;
   colorShiftColor = BNE_870XPItem.colorShiftColor;
...
function BNE_870XPImage::AEOnFire(%this,%obj,%slot)
{
	...
	%obj.stopAudio(0); 
	%obj.playAudio(0, BNE_870XPFire @ getRandom(1, 3) @ Sound);	
...
function BNE_870XPImage::onReloadStart(%this, %obj, %slot)
{
	%obj.aeplayThread(2, shiftleft); 
}

function BNE_870XPImage::onReloadEnd(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function BNE_870XPImage::onReload2End(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function BNE_870XPImage::onReloadStart2(%this, %obj, %slot)
{
	%obj.aeplayThread(2, shiftright);
	serverPlay3D(BNE_870XPPumpBackSound,%obj.getPosition());	
}

function BNE_870XPImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}

function BNE_870XPImage::onReady(%this,%obj,%slot)
{
...
function BNE_870XPImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	parent::onMount(%this,%obj,%slot);
}

function BNE_870XPImage::onUnMount(%this, %obj, %slot)
{	
...
function BNE_870XPImage::LoadEffect(%this,%obj,%slot)
{
...
function BNE_870XPImage::LoadEffectEmpty(%this,%obj,%slot)
{
    ...
    %obj.insertshellSchedule = %this.schedule(200,AEShotgunLoadOne,%obj,%slot);
    schedule(300, %obj, serverPlay3D, BNE_870XPPumpForwardSound, %obj.getPosition());
}

function BNE_870XPImage::AEShotgunLoadOneEffectless(%this,%obj,%slot)
{
...
function BNE_870XPImage::onPump(%this,%obj,%slot)
{
	...
	serverPlay3D(BNE_870XPPumpSound,%obj.getPosition());	
}
...
datablock ShapeBaseImageData(BNE_870XPSafetyImage)
{
   shapeFile = "./870XP/870XP.dts";
   emap = true;
   mountPoint = 0;
...
function BNE_870XPSafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function BNE_870XPSafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
...
function BNE_870XPSafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
...
datablock ShapeBaseImageData(BNE_870XPIronsightImage : BNE_870XPImage)
{
	recoilHeight = 0.5;

	scopingImage = BNE_870XPImage;
	sourceImage = BNE_870XPImage;
	
   offset = "0 0 0";
	eyeOffset = "0 1.25 -0.64";
...
function BNE_870XPIronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function BNE_870XPIronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function BNE_870XPIronsightImage::AEOnFire(%this,%obj,%slot)
{
	%obj.blockImageDismount = true;
	%obj.schedule(500, unBlockImageDismount);
...
function BNE_870XPIronsightImage::onPump(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant); 
...
function BNE_870XPIronsightImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}
...
function BNE_870XPIronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function BNE_870XPIronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
